  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-64 bg-cyan-500/[0.04] rounded-full blur-[80px]" />
      </div>
      ...
      <div className="relative max-w-5xl mx-auto w-full">
        <header className="mb-10 sm:mb-12 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[--text-primary] tracking-[-0.02em]">
            Contact & Socials
          </h2>
          <p className="mt-2 text-[--text-secondary] max-w-lg mx-auto text-sm sm:text-base">
            Open to opportunities, collaborations, and interesting
            conversations. I typically respond within 24 hours.
          </p>
        </header>

        <div className="flex flex-col lg:grid lg:grid-cols-[340px_1fr] gap-6 lg:gap-10 items-start">
          {/* Form — top on mobile, right on desktop */}
          <div className="w-full lg:order-2 glass-card rounded-2xl p-5 sm:p-6 relative overflow-hidden">
            <div className="card-accent-line" aria-hidden="true" />
            <h3 className="text-sm font-bold text-[--text-primary] mb-5 tracking-[-0.01em]">
              Drop a Message
            </h3>
            <ContactForm />
          </div>

          {/* Info sidebar — bottom on mobile, left on desktop */}
          <aside
            className="w-full lg:order-1 flex flex-col gap-3 lg:sticky lg:top-24"
          ...
          >
            <div className="glass-card rounded-2xl p-4 sm:p-5">
              ...
              <div className="flex items-center justify-between gap-3 min-w-0">
                <a
                  ...
                  className="text-sm font-medium text-[--accent-cyan] hover:text-cyan-300 transition-colors break-all min-w-0"
                >
                  {contactInfo.email}
                </a>
                <CopyButton
            ...
            <div className="glass-card rounded-2xl p-4 sm:p-5">
              ...
              <div className="flex flex-col gap-1">
                <a
                  ...
                  className="flex items-center gap-3 py-2.5 px-3 rounded-xl hover:bg-white/[0.04] transition-colors group min-h-[48px]"
                >
                  <Github
                    className="w-4 h-4 text-[--text-faint] group-hover:text-[--text-secondary] transition-colors flex-shrink-0"
                    aria-hidden="true"
                  />
                  <span className="text-sm text-[--text-secondary] group-hover:text-[--text-primary] transition-colors">
                    GitHub
                  </span>
                  <span className="ml-auto text-xs font-mono text-[--text-faint] truncate max-w-[120px]">
                    NayakSubhransu
                  </span>
                </a>
                <a
                ...
                >
                  <Linkedin
                    className="w-4 h-4 text-[--text-faint] group-hover:text-blue-400 transition-colors flex-shrink-0"
                    aria-hidden="true"
                  />
                  <span className="text-sm text-[--text-secondary] group-hover:text-[--text-primary] transition-colors">
                    LinkedIn
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl border border-cyan-500/15 bg-cyan-500/[0.04]">
              <span
                className="w-2 h-2 rounded-full bg-[--accent-cyan] pulse-dot flex-shrink-0"
                aria-hidden="true"
              />
