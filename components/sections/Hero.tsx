...
//   const { name, title, headline, bio, photoPath, photoAlt, resumePath, coverLetterPath, socials } = heroData;
...
//                 />
//                 <div className={`photo-hint${isRevealed ? " revealed" : ""}`} aria-hidden="true">
...
//                 <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 pulse-dot" aria-hidden="true" />
//                 Open to Work
//               </div>
//             </div>

//             {/* ── Social Icons — redesigned ── */}
//             <div className="flex items-center gap-2 mt-2 flex-wrap justify-center" aria-label="Social profiles">
//               {socialItems.map(({ href, label, icon, color, bg, border, glow }) => {
...
//                         : "none",
//                       transform:   isHov ? "translateY(-2px) scale(1.08)" : "none",
//                     }}
//                   >
...
//             <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-[-0.025em] leading-[1.05] gradient-text-primary w-full">
//               {name}
//             </h1>

//             <div className="flex flex-col items-center lg:items-start gap-1">
//               <p className="text-base sm:text-lg font-semibold text-[--text-primary]">{title}</p>
//               <p className="text-sm font-medium text-[--accent-cyan] font-mono tracking-wide">{headline}</p>
//             </div>

//             <p className="max-w-xl text-sm sm:text-base text-[--text-secondary] leading-relaxed">{bio}</p>

//             {/* Stat chips */}
//             <div className="flex flex-wrap justify-center lg:justify-start gap-2" aria-label="Key highlights">
//               {[
//                 { label: "LeetCode", value: "1934",   sub: "Top 4%",    color: "#fbbf24" },
//                 { label: "Problems", value: "1,500+", sub: "Solved",    color: "#22d3ee" },
//                 { label: "CodeChef", value: "3★",     sub: "1682 Peak", color: "#fb923c" },
//                 { label: "Scale",    value: "600K+",  sub: "Users",     color: "#a78bfa" },
//               ].map(({ label, value, sub, color }) => (
//                 <div
//                   key={label}
//                   className="flex flex-col items-center px-3.5 py-2.5 rounded-xl border border-[--border-subtle] bg-white/[0.02] hover:bg-white/[0.04] hover:border-[--border-medium] transition-all duration-200"
//                 >
...
//                   <span className="text-[10px] font-semibold" style={{ color, opacity: 0.7 }}>{sub}</span>
//                 </div>
//               ))}
//             </div>
...
//                 href={resumePath}
//                 download
//                 className="group flex items-center gap-2 px-5 py-3 rounded-xl bg-[--accent-cyan] hover:bg-cyan-300 text-[#07101a] font-bold text-sm transition-all duration-200 shadow-[0_4px_24px_rgba(34,211,238,0.25)] hover:shadow-[0_4px_32px_rgba(34,211,238,0.40)] min-h-[44px]"
//                 aria-label="Download Resume PDF"
//               >
//                 <Download className="w-4 h-4 group-hover:translate-y-0.5 transition-transform" aria-hidden="true" />
//                 Resume
//                 <span className="text-xs font-normal opacity-60">PDF</span>
//               </a>

//               <a
//                 href={coverLetterPath}
//                 download
//                 className="group flex items-center gap-2 px-5 py-3 rounded-xl border border-violet-500/30 bg-violet-500/[0.08] hover:bg-violet-500/[0.16] text-violet-300 hover:text-violet-200 font-semibold text-sm transition-all duration-200 min-h-[44px]"
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="group flex items-center gap-2 px-5 py-3 rounded-xl border border-[--border-medium] bg-white/[0.03] hover:bg-white/[0.07] text-[--text-secondary] hover:text-[--text-primary] font-semibold text-sm transition-all duration-200 min-h-[44px]"
//                 aria-label="Visit GitHub profile"
//               >
//                 <Github className="w-4 h-4" aria-hidden="true" />
//                 GitHub
//                 <ExternalLink className="w-3 h-3 opacity-40 group-hover:opacity-80 transition-opacity" aria-hidden="true" />
//               </a>
//             </div>
//           </div>
//         </div>
...
//       <a
//         href="#experience"
//         className="absolute bottom-20 lg:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-[--text-faint] hover:text-[--text-muted] transition-colors group"
//         aria-label="Scroll to Work Experience"
//       >
//         <span className="text-[10px] font-mono tracking-[0.2em] uppercase opacity-60 group-hover:opacity-100 transition-opacity">Scroll</span>
